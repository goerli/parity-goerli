...
impl Spec {
	...
	fn engine(
		...
		match engine_spec {
			...
			// FIXME: This is odd, every other class is added Arc after, not inside the new
			ethjson::spec::Engine::Clique(clique) => Clique::new(clique.params.into(), machine).expect("Failed to start Clique consensus engine."),
